        ...
        <div class="flex justify-between items-start gap-10">
            <div class="text-white">
                ...
                <div class="flex items-end gap-2 mt-[20px]">
                    <h3 class="md:text-[47px] text-[35px] font-[800] text-white leading-none counter-animation" 
                        data-target="{{$value}}">
                        0
                    </h3>

                    <div class="text-[0.75rem] mb-[4px] flex gap-2 items-center leading-[2px]
                        ...
                        @if($trend < 10)
                            <!-- Down Arrow -->
                            <svg width="20" height="9" viewBox="0 0 15 9" fill="none">
