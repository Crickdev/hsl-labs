			...
			<div class="text-white">
				...
				<div class="flex items-end gap-2 mt-[20px]">
					...
					<div class="text-[0.75rem] mb-[4px] flex gap-2 items-center leading-[2px] {{ $trend < 10 ? 'bg-[#FFE5E5] text-[#FF2A2A]' : 'bg-[#DFFDDD] text-[#008000]' }} rounded-[30px] px-[10px] py-[5px]">
						...
						<path d="M0.55127 0.566406L5.94346 5.81486L8.63955 3.19063L14.0317 8.43909" stroke="#FF2A2A" stroke-width="1.58074"/>
						</svg>
						@else <svg width="15" height="9" viewbox="0 0 15 9" fill="none">
						<path d="M0.55127 8.26587L5.82481 3.13289L8.46159 5.69938L13.7351 0.566406" stroke="#008000" stroke-width="1.58074"/>
						</svg>
						@endif
					</div>
				</div>
